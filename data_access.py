...
from data_models import Base, Measure, Station
...
session.add_all([
    Station(id=1, station_identifier='USC00519397', latitiude=21.2716, longitude=-157.8168, elevation=3.0, name='WAIKIKI 717.2', country='US', state='HI'),
    Station(id=2, station_identifier='USC00513117', latitiude=21.4234, longitude=-157.8015, elevation=14.6, name='KANEOHE 838.1', country='US', state='HI'),
    Station(id=3, station_identifier='USC00514830', latitiude=21.5213, longitude=-157.8374, elevation=7.0, name='KUALOA RANCH HEADQUARTERS 886.9', country='US', state='HI'),
    Station(id=4, station_identifier='USC00517948', latitiude=21.3934, longitude=-157.9751, elevation=11.9, name='PEARL CITY', country='US', state='HI'),
